...
function Landing() {
    return (
        <div className=''>
            <div className="bg-[url('../public/pinkbg.svg')] bg-no-repeat bg-cover">
            ...
            <div className='flex items-center justify-center gap-x-8 px-2 py-2'>
                <div>
            ...
            <div className='flex flex-row-reverse items-center justify-center gap-x-8 px-2 py-2'>
                <div>
            ...
            <div>
                ...
                <div>
                    <h2 className='font-bold text-2xl'>Quicker, more intelligent sales and support.</h2>
                    <p>Ability to customize the virtual agent for your business and continuously improve its performance. </p>
                    <p>To scale the outbound calling process quickly and efficiently.</p>
                    <p>Personalized conversations with prospects, improving the chances of closing deals.</p>
                </div>
            </div>
            <div>
                <div>
                    <h2 className='font-bold text-2xl'>Protecting your data is our top priority</h2>
                    <p>Your data is safe, and you have complete control over it. SalesAgent.ai will never use your data without your permission, and we will only use it for the services you have selected.</p>
                </div>
                <div>
            ...
            <div>
                <p className='font-bold text-2xl'>With our AI-powered sales agent, increase your monthly sales, optimize monthly sales forecasting, and provide high quality leads to salesperson for demos and closure</p>
